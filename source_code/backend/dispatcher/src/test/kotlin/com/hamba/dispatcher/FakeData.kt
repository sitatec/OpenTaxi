...
val fakeDriverData = DriverData(Location(11.310777, -12.312727)/*Near SALA*/, "MALE", "STANDARD", "nearSalaName","nearSala")

// TODO replace places names by distances for collaboration.
val fakeDriverDataList = mutableListOf<DriverData>().apply {
    add(DriverData(Location(11.307769, -12.315753) /*NEAR ORIGIN*/, "FEMALE", "STANDARD", "nearORIGINName","nearORIGIN"))
    add(DriverData(Location(11.312763, -12.320231) /*GARAGE MALAL*/, "MALE", "VAN", "garageMalalName","garageMalal"))
    add(
        DriverData(
            Location(11.312739, -12.313941)  /*PHARMACIE N'DIOLOU (FACE PERGOLA)*/,
            "MALE",
            "PREMIUM",
            "pharmacieNdiolouName",
            "pharmacieNdiolou"
        )
    )
    add(DriverData(Location(11.259205, -12.367215) /*GARAMDBE*/, "MALE", "VAN", "name","garambe"))
    add(DriverData(Location(11.224548, -12.353052) /*TIMBO*/, "FEMALE", "LITE", "name", "timbo"))
    add(DriverData(Location(11.330455, -12.295603) /*LABE AIRPORT*/, "FEMALE", "STANDARD", "name", "labeAirport"))
    add(fakeDriverData)
}
