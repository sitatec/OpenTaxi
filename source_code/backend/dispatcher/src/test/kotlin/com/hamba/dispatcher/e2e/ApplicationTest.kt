...
class ApplicationTest {
    ...
    fun testDriverDataManagement() {
        withTestApplication({ webSocketsServer(driverConnections, driverDataRepository, dispatchDataList, dispatcher, driverDataCache, firebaseDatabaseClient) }) {
    ...
    fun testDispatching() {
        withTestApplication({ webSocketsServer(driverConnections, driverDataRepository, dispatchDataList, dispatcher, driverDataCache, firebaseDatabaseClient) }) {
            ...
            handleWebSocketConversation("/dispatch") { incoming, outgoing ->
                delay(15_000)// Wait until all fake drivers have been connected.
